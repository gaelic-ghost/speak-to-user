...
- [ ] Improve automated test coverage with formal coverage reporting, a few higher-signal integration tests around model/profile workflows, and an optional sequential-only e2e suite for model-generating routes.
